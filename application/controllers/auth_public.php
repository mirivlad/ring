...
class Auth_public extends CI_Controller {
	...
	*/
	...
	function dashboard()
	{
		...
		$this->load->view('public/dashboard_view', $this->data);
	}
	...
	function update_email($user_id = FALSE, $token = FALSE)
	{
		...
		if ($this->flexi_auth->is_logged_in())
		{
			...
			$this->load->view('public/email_update_view', $this->data);
		}
		else
		{
			redirect('auth/login');
	...
	function manage_address_book()
	{
		...
		$this->load->view('public/address_view', $this->data);		
	}
	...
	function insert_address()
	{
		...
		$this->load->view('public/address_insert_view', $this->data);		
	}
	...
	function update_address($address_id = FALSE)
	{
		...
		$this->load->view('public/address_update_view', $this->data);		
	}
}
