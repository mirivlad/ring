	...
	*/
    ...
    {	
		...
		if ($this->flexi_auth->ip_login_attempts_exceeded())
		{
			 ...
			 * 
			 * Note: To use this example, you will also need to enable the recaptcha examples in 'models/auth_model.php', and 'views/login_view.php'.
			*/
			 ...
			 *
			 * Note: To use this example, you will also need to enable the math_captcha examples in 'models/auth_model.php', and 'views/login_view.php'.
			*/
	...
	function register_account()
	{
		...
		$this->load->view('public/register_view', $this->data);
	}
	...
	function resend_activation_token()
	{
		...
		$this->load->view('public/resend_activation_token_view', $this->data);		
	}
	...
	function forgotten_password()
	{
		...
		$this->load->view('public/forgot_password_view', $this->data);		
	}
	...
	function manual_reset_forgotten_password($user_id = FALSE, $token = FALSE)
	{
		...
		$this->load->view('public/forgot_password_update_view', $this->data);
	}
